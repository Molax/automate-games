"""
Bar selector UI for the Priston Tale Potion Bot
---------------------------------------------
This module handles the UI components for bar selection.
"""
...
class BarSelectorUI:
    """Class that handles the UI for bar selection"""
    ...
    def _create_ui(self):
        ...
        window_frame = ttk.LabelFrame(self.parent, text="Game Window", padding=10)
        ...
        bars_frame = ttk.LabelFrame(self.parent, text="Bar Selection", padding=10)
